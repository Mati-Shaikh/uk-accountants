    ...
    return (
        <div className="min-h-screen bg-blue-400 flex justify-center items-center">
            <div className="max-w-5xl mx-auto px-6">
                <h3 className="text-3xl font-bold text-center text-white mb-8">Your Growth is Important to us!</h3>
                <h2 className="text-3xl font-bold text-center text-white mb-8">How To Contact Us</h2>
